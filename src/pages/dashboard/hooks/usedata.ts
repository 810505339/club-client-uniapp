...
export default () => {
  const list = ref([
    { id: 0, color: '#E6A055FF', box: box0, btn: btn0, text: 'dashboard.text1', tag: 'dashboard.tag', value: '2534' },
    { id: 1, color: '#3ADBCBFF', box: box1, btn: btn1, text: 'dashboard.text2', tag: 'dashboard.tag1', value: '2534' },
    { id: 2, color: '#FF6035FF', box: box2, btn: btn2, text: 'dashboard.text3', tag: 'dashboard.tag1', value: '2534' },
    { id: 3, color: '#759BFFFF', box: box3, btn: btn3, text: 'dashboard.text4', tag: 'dashboard.tag1', value: '2534' },
    { id: 4, color: '#FAAD14FF', box: box4, btn: btn4, text: 'dashboard.text5', tag: 'dashboard.tag1', value: '2534' },
  ])
  return {
    list
  }
